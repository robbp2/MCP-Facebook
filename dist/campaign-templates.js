...
exports.fillPromptTemplate = exports.getPromptTemplate = exports.prompts = void 0;
exports.prompts = {
...
const getPromptTemplate = (name) => {
    const promptName = name;
    return exports.prompts[promptName] || null;
};
exports.getPromptTemplate = getPromptTemplate;
// Funkce pro vyplnění šablony konkrétními argumenty
const fillPromptTemplate = (name, args) => {
    const template = (0, exports.getPromptTemplate)(name);
    if (!template) {
